  ...
  return (
    <div className="mt-20 pb-30">
      <div className="w-full px-6">
        <div className="text-center flex flex-col items-center justify-center relative mb-20 select-none">
          <h2 className="mb-6">Portofolio</h2>
          <h3 className="relative inline-block text-7xl md:text-8xl uppercase font-semibold">
            <span className="inline-block relative">Evolusi</span>
          </h3>
          <h2 className="mt-6 inline-block text-md">
            Menggabungkan presisi teknis dengan kreativitas tanpa batas. Selamat
            datang di era baru desain bersama Grodit Studio.
          </h2>
        </div>
        ...
        <div className="flex flex-col items-center justify-center mt-10">
          <Link to="/portofolio" className="group relative">
